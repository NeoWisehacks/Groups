    ...
    <View style={styles.loginSignup}>
      <View style={styles.signuplogin}>
        ...
        <View style={[styles.frameParent, styles.parentSpaceBlock]}>
          <Pressable onPress={()=>navigation.navigate("Login")} style={[styles.loginWrapper, styles.loginWrapperFlexBox]}>
        ...
        <View style={styles.parentSpaceBlock}>
          <View style={[styles.passwordParent, styles.passwordBorder]}>
            <TextInput placeholder="Name" style={styles.password} value={name} onChangeText={setName}/>
            <Image
          ...
          <View style={[styles.passwordGroup, styles.passwordGroupFlexBox]}>
            <TextInput placeholder="Password" style={styles.password} value={password}
