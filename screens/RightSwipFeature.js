...
const RightSwipFeature = () => {
  return (
    <View style={styles.rightSwipFeature}>
      <View style={[styles.frameParent, styles.swipLayout1]}>
        ...
        <View style={styles.swipeLeftToDislikeAndRighParent}>
          ...
          <View style={styles.heroiconsMinihandThumbDownParent}>
            <Image
              ...
              contentFit="cover"
              source={require("../assets/heroiconsminihandthumbdown.png")}
            />
            <Image
              style={[styles.addToCollection, styles.addToCollectionLayout]}
              contentFit="cover"
              source={require("../assets/add-to-collection.png")}
            />
            <Image
              style={[styles.addToCollection, styles.addToCollectionLayout]}
              contentFit="cover"
              source={require("../assets/heroiconsminihandthumbup.png")}
            />
          </View>
        </View>
      </View>
      <View style={[styles.swip, styles.swipLayout]}>
        <Image
      ...
      <Image
        style={[styles.swipIcon, styles.swipLayout]}
        contentFit="cover"
        source={require("../assets/swip.png")}
      />
    </View>
  );
};
...
export default RightSwipFeature;
